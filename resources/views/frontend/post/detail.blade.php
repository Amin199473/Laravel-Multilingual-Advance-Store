...
@section('title')
    {{ session()->get('language') =='persian' ? $post->post_title_persian : $post->post_title_en}}
@endsection
        ...
        <div class="container">
            <div class="breadcrumb-inner">
                <ul class="list-inline list-unstyled">
                    <li><a href="#">Home</a></li>
                    <li class='active'> {{ session()->get('language') =='persian' ? $post->post_title_persian : $post->post_title_en}}</li>
                </ul>
                ...
                <div class="blog-page">
                    <div class="col-md-9">
                        <div class="blog-post wow fadeInUp">
                            ...
                            <p>{!! session()->get('language') =='persian' ? $post->post_details_persian : $post->post_details_en !!}</p>
