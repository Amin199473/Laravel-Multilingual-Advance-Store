                ...
                <div class="col-8">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Category list <span class="badge badge-pill badge-danger">{{ count($postCategories) }}</span> </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                    ...
                                    <tbody>
                                        @foreach ($postCategories as $key => $category)
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    <div class="row">
                                                        <a href="{{ route('postCategory.edit', $category->id) }}" class="btn btn-info ml-2"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                                                        <form method="POST" action="{{ route('postCategory.destroy', $category->id) }}" id="form" data-id="{{ $category->id }}" class="form-inline">
                                                            @csrf
                                                            @method('DELETE')
